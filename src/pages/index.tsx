...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>ZoneTactics - Créateur de tactiques basketball</title>
        <meta name="description" content="Créez et partagez des tactiques basketball dynamiques avec ZoneTactics. Interface intuitive, animations détaillées et commentaires vocaux pour optimiser votre coaching." />
        <meta name="keywords" content="basketball, tactiques, coaching, animations, ZoneTactics" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="ZoneTactics - Créateur de tactiques basketball" />
        <meta property="og:description" content="Le nouveau moyen de créer et d'expliquer ses tactiques basketball" />
      ...
      <div className="flex flex-col min-h-screen bg-bleu">
        <Header />
      <motion.div
        className="flex flex-col items-center text-center px-4 sm:px-8 mt-4 sm:mt-8"
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
      >
        <motion.button
          className="bg-transparent text-white border border-white py-2 px-4 rounded-full mb-6 sm:mb-8 cursor-default text-xs sm:text-sm md:text-base"
        ...
        <motion.h1
          className="text-white text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium mb-6 sm:mb-8 w-full sm:w-11/12 md:w-9/12 leading-tight"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.p
          className="text-white text-sm sm:text-base md:text-lg max-w-xs sm:max-w-md md:max-w-2xl mb-8 sm:mb-10 leading-relaxed px-2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div className="w-full max-w-sm sm:max-w-md space-y-4 sm:space-y-0 sm:space-x-4 flex flex-col sm:flex-row sm:justify-center">
          {isSignedIn ? (
            <>
              <Link href="/createsystem" className="w-full sm:w-auto">
                <motion.button
                  className="bg-white text-black py-3 px-6 rounded-full shadow-lg w-full sm:w-auto font-medium text-sm sm:text-base"
              ...
              <Link href="/pricing" className="w-full sm:w-auto">
                <motion.button
                  className="bg-transparent text-white border border-white py-3 px-6 rounded-full w-full sm:w-auto font-medium text-sm sm:text-base hover:bg-white hover:text-black transition-colors"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
      ...
      <main className="flex flex-col items-center mt-8 sm:mt-10 flex-grow px-4">
        <motion.div
          className="rounded-lg p-2 sm:p-4 mb-8 sm:mb-10 w-full max-w-4xl"
        ...
        <section
          ref={featuresRef}
          className="text-center text-white w-full max-w-6xl mx-auto px-4"
          id="features"
        >
          <motion.h2
          ...
          <motion.p
            className="text-base sm:text-lg md:text-xl mb-8 sm:mb-10 max-w-3xl mx-auto"
            initial={{ opacity: 0 }}
          ...
          >
            <motion.div
              className="bg-blue-300 bg-opacity-10 p-4 sm:p-6 rounded-lg shadow-md"
              whileHover={{ scale: 1.02 }}
            >
              <div className="flex flex-col sm:flex-row items-center text-center sm:text-left mb-4">
                <div className="p-2 sm:p-3 mb-3 sm:mb-0">
                  <Image
                    src="/img/Icon1.png"
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold sm:ml-4">
            ...
            <motion.div
              className="bg-blue-300 bg-opacity-10 p-4 sm:p-6 rounded-lg shadow-md md:col-span-2"
              whileHover={{ scale: 1.01 }}
            >
              <div className="flex flex-col sm:flex-row items-center text-center sm:text-left mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 mb-3 sm:mb-0">
                  <Image
                    src="/img/Icon3.png"
              ...
              <div className="flex flex-col lg:flex-row items-center gap-6">
                ...
                <div className="w-full lg:w-1/2 flex justify-center items-center">
                  <Image
                    ...
                    width={400}
                    height={300}
                    className="rounded-lg w-full h-auto object-contain max-w-md"
                  />
                </div>
              </div>
            </motion.div>
        ...
        <section
          ref={aboutRef}
          id="about"
          className="text-center text-white mt-12 sm:mt-16 md:mt-20 mb-12 sm:mb-16 md:mb-20 w-full max-w-5xl mx-auto px-4"
        >
          <motion.h2
          ...
          <motion.div
            className="bg-blue-300 bg-opacity-10 p-6 sm:p-8 md:p-10 rounded-lg shadow-lg"
            initial={{ opacity: 0 }}
